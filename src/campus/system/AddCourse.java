...
public class AddCourse extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(Video, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(24, 24, 24))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            admin.addCourse(Integer.parseInt(ID.getText()), Name.getText(), Booklet.getText(), Video.getText(), Solution.getText(), Date.getText(), Time.getText());
            admin.setPoineterCourses();
            Rs.absolute(count);
            Rs.next();
            table.addRow(new Object[]{Rs.getInt("ID"), Rs.getString("NAME"), Rs.getString("BOOKLET"), Rs.getString("VIDEO"), Rs.getString("TESTSOLUTION"), Rs.getString("DATE"), Rs.getString("TIME")});
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.toBack();
        AddTimetable addStudent = new AddTimetable(CourseID);
        addStudent.show();
